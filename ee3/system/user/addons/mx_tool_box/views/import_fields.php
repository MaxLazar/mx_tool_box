...
<?php endif; ?>
<?php //success
echo form_open(ee('CP/URL')->make('cp/addons/settings/mx_tool_box/import_fields'));
?>		
...
<?php
				...
				{
					$check = (!isset($field['uniq'])) ? '<img src="'.$img_path.'user/mx_tool_box/images/checkmark.png" alt="'.lang('ready2import').'" title="'.lang('ready2import').'" />' : '<img src="'.$img_path.'user/mx_tool_box/images/hand_1.png" alt="'.lang('d_names').'" title="'.lang('d_names').'" />' ; 
